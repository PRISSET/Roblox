...
#ifndef ZSTD_DATAExternalExecutor_SANITIZER
# if __has_feature(dataExternalExecutor_sanitizer)
#  define ZSTD_DATAExternalExecutor_SANITIZER 1
# else
#  define ZSTD_DATAExternalExecutor_SANITIZER 0
# endif
#endif
...
#    elif ZSTD_DATAExternalExecutor_SANITIZER
#      define ZSTD_ASM_SUPPORTED 0
#    else
